    ...
    */
    class MySendMail {
        ...
        */       
        ...
        echo htmlspecialchars('Send command:'.$command.',expected code:'.$code).'<br />';
			try {
        ...
        private function socketSecurity() {
			...
			$this->_socket = stream_socket_client($remoteAddr, $errno, $errstr, 10);
        ...
        */
		...
		public function sendMail() {
            ...
            foreach ($command as $value) {
                if($this->sendCommandSecurity($value[0], $value[1])) {
                    continue;
                }
                else{
                    return false;
    ...
    /**************************** Test ***********************************/
     $mail = new MySendMail();
    $mail->setServer("smtp.qq.com", "460509950@qq.com", "ajojptdbsjsrbgci",465);
    $mail->setFrom('460509950@qq.com');
    $mail->setReceiver('656143571@qq.com');
   // $mail->setCc("XXXXX@XXXXX");
    //$mail->setCc("XXXXX@XXXXX");

    $mail->setMailInfo("这11111是fff一个", "这是一vvvdddwww个简111111111单的UTF-8邮件发送功能", "");
    $mail->sendMail(); 
?> 